...
--   local converter = require("converter_1.3_to_1.4")
...
function converter.convert(quest_path)
  ...
  local quest_properties_converter = require("1.3_to_1.4/quest_properties_converter_1_3")
  ...
  local font_list_converter = require("1.3_to_1.4/font_list_converter_1_3")
  ...
  local quest_db_converter = require("1.3_to_1.4/quest_db_converter_1_3")

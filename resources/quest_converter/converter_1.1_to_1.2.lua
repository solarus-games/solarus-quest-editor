...
-- Usage:
--   local converter = require("converter_1.1_to_1.2")
...
function converter.convert(quest_path)
  ...
  local quest_properties_converter = require("1.1_to_1.2/quest_properties_converter_1_1")
  ...
  local quest_db_converter = require("1.1_to_1.2/quest_db_converter_1_1")
  local resources = quest_db_converter.convert(quest_path)

  -- Convert maps.
  write_info("  Converting maps...")
  local map_converter = require("1.1_to_1.2/map_converter_1_1")
  ...
  local strings_converter = require("1.1_to_1.2/strings_converter_1_1")
  ...
  local sounds_converter = require("1.1_to_1.2/sound_converter_1_1")

...
-- Usage:
--   local converter = require("converter_1.0_to_1.1")
...
function converter.convert(quest_path)
  ...
  local language_list_converter = require("1.0_to_1.1/language_list_converter_1_0")
  ...
  local quest_properties_converter = require("1.0_to_1.1/quest_properties_converter_1_0")
  ...
  local quest_db_converter = require("1.0_to_1.1/quest_db_converter_1_0")
  local resources = quest_db_converter.convert(quest_path, languages)

  -- Convert tilesets.
  write_info("  Converting tilesets...")
  local tileset_converter = require("1.0_to_1.1/tileset_converter_1_0")
  ...
  local sprite_converter = require("1.0_to_1.1/sprite_converter_1_0")

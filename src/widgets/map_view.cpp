...
// Test floor borders.
BorderSet floor_border_set(QStringList({
...
// Test walls.
BorderSet wall_border_set(QStringList({
  "wall.4-2",  // Right.
  "wall.1-2",  // Up.
  "wall.3-2",  // Left.
  "wall.2-2",  // Down.
...
// Test outside paths.
BorderSet path_border_set(QStringList({
  "grass.soil.3",  // Right.
  "grass.soil.2",  // Up.
  "grass.soil.4",  // Left.
  "grass.soil.1",  // Down.
...
BorderSet deep_water_border_set(QStringList({
